    ...
    <div class="whiteBoxWrap">
      <div class="whiteBox send">
        ...
        <div class="formBox">
          ...
          <div v-if="auth == 1">
            <div class="form-item">
              <div class="form-item-line1">
                ...
                <input class="right" v-model="kouLing" type="text" ref="ipt" placeholder="请输入" />
              </div>
          ...
          <div v-if="showmore" class="more" @click="showMore">收起更多</div>
          <div class="banner">
...
<script src="./sendredpkt.js">
</script>
<style lang="less" src="./sendredpkt.less" scoped>
</style>
