...
export default {
    ...
    methods: {
        ...
        onConfirm(value, index) {
            ...
            this.currentTokenBalance = this.tokenaMount[index];
        ...
        passwordConfirm(done) {
            ...
            this.$post2("/redpkt/index/sendpkt", {
                ...
                tradepwd: this.$SHA256(this.psd), //密码
                ...
                .then(res => {
                    ...
                    let params = { rid: res.rid, app: res.app };
        ...
        //服务费
        getfee(isAmount) {
            console.log("amount:" + this.tokenaMount[this.mountIndex]);
            this.currentTokenBalance = this.tokenaMount[this.mountIndex];
            if (parseFloat(isAmount) > this.tokenaMount[this.mountIndex]) {
                this.tipShow = true;
            } else {
                this.tipShow = false;
            }

            // console.log("amount:" + isAmount + ",token:" + this.value);
    ...
    created() {
        ...
        this.$post2("user/api/index/userAsset").then(res => {
            console.log("user/api/index/userAsset", res);
